...
function startHtml() {
  ...
  console.log(
    "Let's get started! The following set of prompts will walk you through generating a profile page for your team."
  );
}
      ...
      data = `<div class="max-w-md rounded shadow-md shadow-indigo">       
            <div class="p-4 bg-sky-100">
              <h1 class="text-gray-dark text-xl md:text-3xl font-roboto mt-5">${name} </h1>
                  <p class="sm:text-xl">${role}</p>
                  <p class="mt-2 sm:text-l"><strong>ID:</strong> ${id} </p>
                  <p class="mt-2 sm:text-l"><strong>E-mail:</strong> <a class="text-indigo-500" href="mailto:${email}">${email}</a></p>
...
function finishHtml() {
  ...
  console.log(
    "Your file has been generated! Go check the dist folder. Thanks!"
  );
}
